  ...
  <Teleport to="body">
    ...
    >
      <div class="bg-white rounded p-4 md:p-6 w-11/12 max-w-md relative">
        ...
        <h3 class="text-lg md:text-xl font-medium text-center mb-3 md:mb-4">
          {{ $t('dialogs.endConfirm.title') }}
        </h3>
        <p class="text-center text-sm mb-4 md:mb-6">
          {{ $t('dialogs.endConfirm.message') }}
        </p>
...
const props = defineProps({
  ...
  message: {
    type: String,
    default:
      'Ending this activity will stop the timer and mark the activity as done. This cannot be undone.',
  },
  confirmText: {
    type: String,
