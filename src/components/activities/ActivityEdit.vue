...
<template>
  <Teleport to="body">
    <div v-if="visible" class="fixed inset-0 flex items-center justify-center bg-opacity-50 z-50">
        ...
        <div class="p-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <div class="relative">
                <select
                  ...
                  class="appearance-none w-full border rounded p-2 pr-8"
                >
            ...
            <div v-if="localActivity.type === 'Production'">
              ...
              <div class="flex">
                ...
                <button @click="incrementAmount" class="px-2 border-t border-b border-r rounded-r">
                  +
                </button>
              </div>
            </div>
          ...
          <div class="mb-4">
            <div class="flex justify-between items-center mb-2">
              ...
              <button @click="toggleAddOns" class="text-sm text-blue-600 hover:text-blue-800">
            ...
            <div
              v-if="showAddOns"
              class="grid grid-cols-1 md:grid-cols-2 gap-4 border p-3 rounded bg-gray-50"
            >
              <div v-for="(addon, key) in addOns" :key="key" class="mb-2">
                ...
                <div class="flex">
                  ...
                  />
                  <button
                    @click="decrementAddOn(key)"
                    class="px-2 border-t border-b border-r text-sm"
                  >
                    −
                  </button>
                  <button
                    @click="incrementAddOn(key)"
                    class="px-2 border-t border-b border-r rounded-r text-sm"
                  >
                    +
                  </button>
                </div>
